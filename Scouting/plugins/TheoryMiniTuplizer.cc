// -*- C++ -*-
//
// Package:    MuonAnalysis/TheoryMiniTuplizer
// Class:      TheoryMiniTuplizer
// 
/**\class TheoryMiniTuplizer TheoryMiniTuplizer.cc MuonAnalysis/TheoryMiniTuplizer/plugins/TheoryMiniTuplizer.cc

 Description: Makes minituples for theory
